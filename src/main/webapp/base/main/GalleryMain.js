...
class Gallery {
     ...
     * @param {Boolean} [options.introBackgroundMontageRandom=true]
     * Set to true (the default) to randomize the order of the intro montage
     *
     * *** EVENTS ***
    ...
    constructor(el, options) {
        ...
        this.settings = Object.assign({}, {
            ...
            // Randomize order of background montage images
            introBackgroundMontageRandom: true,
    ...
    initIntroBackgroundMontage() {
        ...
        if (this.settings.introBackgroundMontageRandom) {
